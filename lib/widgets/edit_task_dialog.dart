...
class EditTaskDialog extends StatefulWidget {
  ...
  final Function(String title, String description, DateTime? dueDate,
      TaskPriority priority, TaskCategory category) onUpdateTask;
...
class _EditTaskDialogState extends State<EditTaskDialog> {
  ...
  void initState() {
    ...
    // Extract time from the task's due date if it exists
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child:
                        Text('Update Task', style: TextStyle(fontSize: 16.sp)),
                  ),
                ),
              ],
            ),
